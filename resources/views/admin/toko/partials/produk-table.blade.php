        ...
        <div class="card border-0 shadow-sm rounded-4 p-4">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                ...
                <div class="d-flex flex-wrap align-items-center gap-2">
                    ...
                    <!-- TAMBAH -->
                    <a href="{{ route('admin.toko.produk.create', $toko->id) }}"
                ...
                <table class="table table-bordered table-hover align-middle" id="tableProduk">
                    <thead>
                        <tr>
                            ...
                            <th colspan="2" style="width:200px;">Status</th>
                            <th rowspan="2" width="300">Aksi</th>
                        </tr>
                        <tr>
                            ...
                            <tr data-active="{{ $produk->is_active }}" data-verified="{{ $produk->is_verified }}">
                                ...
                                <td class="text-center td-aksi">
                                    <div class="d-flex flex-wrap gap-1 justify-content-center">
                                        ...
                                        <a href="{{ route('admin.produks.show', $produk->id) }}"
                                        ...
                                        <button
                                            ...
                                            onclick="confirmToggle('{{ route('admin.produks.toggleActive', $produk->id) }}', {{ $produk->is_active ? 'true' : 'false' }}, 'active')">
                                        ...
                                        <button
                                            ...
                                            onclick="confirmToggle('{{ route('admin.produks.toggleVerified', $produk->id) }}', {{ $produk->is_verified ? 'true' : 'false' }}, 'verified')">
                                            <i class="bi {{ $produk->is_verified ? 'bi-patch-check-fill' : 'bi-patch-exclamation' }}"></i>
                                        </button>
...
<script>
    ...
    function confirmToggle(url, currentStatus, type) {
        let text = type === 'active'
            ? currentStatus ? 'Produk akan dinonaktifkan.' : 'Produk akan diaktifkan.'
            : currentStatus ? 'Status verifikasi dibatalkan.' : 'Produk akan diverifikasi.';
    ...
    function handleDelete(url) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                .then(res => res.json())
                .then(res => Swal.fire('Berhasil', res.message, 'success').then(() => location.reload()))
