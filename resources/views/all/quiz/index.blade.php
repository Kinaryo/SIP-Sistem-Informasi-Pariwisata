    ...
    <div class="container py-5 bg-light">
        <div class="card border-0 shadow-lg rounded-4 p-4 p-md-5">
            <div class="text-center mb-5">
                <h2 class="fw-bold display-6 text-dark">Quiz</h2>
                <p class="text-muted mt-3">
                    Uji pengetahuanmu seputar fakta menarik dari Indonesia
                </p>
            </div>
            <div class="row g-4">
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                @foreach ($lb['topScores'] as $index => $result)
                                                    ...
                                                    @endphp
                                                    <tr @if ($isCurrentUser) class="table-success fw-semibold" @endif>
                                                        ...
                                                        <td class="align-middle" style="font-size:0.88rem;">
                                                            {{ $result->user->name }}
                                                            @if ($isCurrentUser)
                                                                <span class="text-primary fw-bold ms-1" title="Ini Anda">★</span>
                                                            @endif
                                                        </td>
                                                    ...
                                                    <tr class="table-success fw-semibold">
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <small class="text-muted fw-semibold">{{ $percent }}%</small>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endif
