...
<div class="modal fade" id="editHeroModal">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <form method="POST" action="{{ route('admin.updateHero', $tourism_place->id) }}" enctype="multipart/form-data"
            class="modal-content">
            @csrf
            @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <select name="category_id" class="form-select">
                        @foreach(\App\Models\Category::orderBy('name')->get() as $cat)
                            <option value="{{ $cat->id }}" @selected($tourism_place->category_id == $cat->id)>{{ $cat->name }}
                            </option>
                        @endforeach
                    </select>
                </div>
...
<div class="modal fade" id="editDescriptionModal">
    <div class="modal-dialog modal-lg">
        <form method="POST" action="{{ route('admin.updateDescription', $tourism_place->id) }}" class="modal-content">
            @csrf
            @method('PUT')
            <div class="modal-header">
...
<div class="modal fade" id="editFacilitiesModal">
    <div class="modal-dialog modal-lg">
        <form method="POST" action="{{ route('admin.updateFacilities', $tourism_place->id) }}" class="modal-content">
            @csrf
            @method('PUT')
            <div class="modal-header">
...
<div class="modal fade" id="addGalleryModal">
    <div class="modal-dialog">
        <form id="addGalleryForm" method="POST" action="{{ route('admin.storeGallery', $tourism_place->id) }}"
...
<div class="modal fade" id="editGalleryModal">
    <div class="modal-dialog">
        <form id="editGalleryForm" method="POST" action="" enctype="multipart/form-data" class="modal-content">
            @csrf
            @method('PUT')
            <div class="modal-header">
                <h5>Edit Foto</h5>
...
<div class="modal fade" id="editInfoModal">
    <div class="modal-dialog">
        <form method="POST" action="{{ route('admin.updateInfo', $tourism_place->id) }}" class="modal-content">
            @csrf
            @method('PUT')
            <div class="modal-header">
...
<div class="modal fade" id="editLocationModal">
    <div class="modal-dialog modal-lg">
        <form method="POST" action="{{ route('admin.updateLocation', $tourism_place->id) }}" class="modal-content">
            @csrf
            @method('PUT')
            <div class="modal-header">
